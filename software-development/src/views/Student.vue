    ...
    <nav>
        <v-toolbar>
            ...
            <v-toolbar-title class="black--text">
                <span class="font-weight-light">学生</span>
            </v-toolbar-title>
            <v-spacer></v-spacer>
                    ...
                    <v-list-item link @click="$router.push({path: '/home'})">
                        ...
                        >
                            <template v-slot:activator>
                                <v-list-item-content>
                                    <v-list-item-title class="white--text">学生查询用户信息</v-list-item-title>
                                </v-list-item-content>
                            </template>
...
export default Vue.extend({
    ...
    data() {
        return{
            ...
            group: null,
            searchlinks: [
                {title: '查询学生信息',route: '/querystu'},  
            ],
            managelinks: [
                {title: "管理学生信息",route: '/managestu'},
            ]
        }
    }
})
